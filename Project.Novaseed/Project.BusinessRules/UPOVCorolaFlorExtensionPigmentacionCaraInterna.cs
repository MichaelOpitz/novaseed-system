...
{
    public class UPOVCorolaFlorExtensionPigmentacionCaraInterna
    {
        private int id_corola_flor_extension_pigmentacion_cara_interna;
        private string nombre_corola_flor_extension_pigmentacion_cara_interna;
        ...
        public UPOVCorolaFlorExtensionPigmentacionCaraInterna(int id_corola_flor_extension_pigmentacion_cara_interna,
