...
namespace Project.BusinessRules
{
    ...
    {
        private string ubicacion_madre, nombre_tamaño, nombre_madurez, nombre_tipo_hoja,
        ...
        public Madre(string codigo_variedad, string nombre_variedad, int id_tamaño, int id_madurez, int id_tipo_hoja, 
            ...
            int id_numero_tuberculos, int id_fertilidad, int id_destino, string ubicacion_madre)
            : base(codigo_variedad,nombre_variedad,id_tamaño,id_madurez,id_tipo_hoja,id_calidad_piel,id_forma,id_distribucion_calibre,
        ...
        /*
         * Constructor sin ubicacion madre
         */
        public Madre(string codigo_variedad, string nombre_variedad, int id_tamaño, int id_madurez, int id_tipo_hoja,
            int id_calidad_piel, int id_forma, int id_distribucion_calibre, int id_profundidad, int id_regularidad,
            int id_desarrollo_follaje, int id_brotacion, int id_emergencia, int id_emergencia_40_dias, int id_metribuzina,
        ...
        public Madre(string codigo_variedad, string nombre_variedad, string nombre_tamaño, string nombre_madurez, string nombre_tipo_hoja,
        ...
        public Madre(int id_tamaño, int id_madurez, int id_tipo_hoja,
            int id_calidad_piel, int id_forma, int id_distribucion_calibre, int id_profundidad, int id_regularidad,
            int id_desarrollo_follaje, int id_brotacion, int id_emergencia, int id_emergencia_40_dias, int id_metribuzina,
            int id_tuberculos_verdes, int id_tizon_tardio_follaje, int id_tizon_tardio_tuberculo,
            int id_numero_tuberculos, int id_fertilidad, int id_destino)
