...
namespace Project.BusinessRules
{
    public class Padre : Variedad
    {
        ...
        public Padre(string codigo_variedad, string nombre_variedad, string nombre_tamaño, string nombre_madurez,
        ...
        public Padre(int id_tamaño, int id_madurez, int id_forma, int id_distribucion_calibre, int id_profundidad, 
            int id_regularidad, int id_brotacion, int id_emergencia, int id_emergencia_40_dias, int id_metribuzina,
