...
namespace Project.BusinessRules
{
    ...
    {
        private string ubicacion_padre, nombre_tamaño, nombre_madurez, nombre_tipo_hoja,
        ...
        public Padre(string codigo_variedad, string nombre_variedad, int id_tamaño, int id_madurez, int id_tipo_hoja, 
            ...
            int id_numero_tuberculos, int id_fertilidad, int id_destino, string ubicacion_padre)
        ...
        /*
         * Constructor sin ubicacion padre
         */
        public Padre(string codigo_variedad, string nombre_variedad, int id_tamaño, int id_madurez, int id_tipo_hoja,
            int id_calidad_piel, int id_forma, int id_distribucion_calibre, int id_profundidad, int id_regularidad,
            int id_desarrollo_follaje, int id_brotacion, int id_emergencia, int id_emergencia_40_dias, int id_metribuzina,
