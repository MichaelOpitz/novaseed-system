...
namespace Project.Novaseed
{
    public partial class Cosecha48papas : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.lbl48papasErrorEnfermedad.Visible = false;
            this.lbl48papasErrorEnfermedad.Text = "";
            if (!Page.IsPostBack)
            {
        ...
        */
        ...
        protected void btn48papasAgregarEnfermedad_Click(object sender, EventArgs e)
        {
            try
            {
                this.lbl48papasErrorEnfermedad.Visible = true;
                ...
                if (!id_enfermedad.Equals("1"))
                {
                    ...
                    else
                    {
                        ...
                        string existeEnfermedad = listEnfermedad.Find(x => x == this.ddl48papasEnfermedad.SelectedItem.ToString());
                        if (existeEnfermedad == null)
                        {
                            ...
                            this.lbl48papasErrorEnfermedad.Text += "La enfermedad seleccionada ya existe.<br/>";
                    ...
                    this.lbl48papasErrorEnfermedad.Text += "Debe seleccionar una enfermedad.<br/>";
            }
            catch (Exception ex)
            {
            }
        ...
        protected void ddlPageSize_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                this.gdv48papas.SelectedIndex = -1;
                GridViewRow pagerRow = gdv48papas.BottomPagerRow;
                DropDownList pageSizeList = (DropDownList)pagerRow.Cells[0].FindControl("ddlPageSize");
