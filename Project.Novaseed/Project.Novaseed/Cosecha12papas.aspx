    ...
    <div class="container-fluid">
        ...
        <div class="progress progress-striped active">
            <div class="progress-bar" role="progressbar"
                aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width: 70%">Etapa 5, Cosecha 12 Papas                
            </div>
        </div>
        <div class="row">
            <div class="col-sm-8">
                            ...
                            <div class="col-sm-9 col-sm-offset-3">
                                <div class="row">
                                    <h5 style="margin-left:20px">
                                        <asp:Label ID="lbl12papasErrorEnfermedad" runat="server" Font-Bold="true" Text="" ForeColor="Red" /></h5>
                                </div>
