...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid">
        ...
        <div class="col-sm-6" style="text-align: right">
            <div class="input-group" style="margin-top: 30px">
                <asp:TextBox runat="server" type="text" class="form-control" ID="txtUPOVReporteBuscar" placeholder="Ingrese nombre de variedad"></asp:TextBox>
                <span class="input-group-btn">
                    <asp:Button runat="server" class="btn btn-default" type="button" ID="btnUPOVReporteBuscar" Text="Buscar" OnClick="btnUPOVReporteBuscar_Click"></asp:Button>
                </span>
            </div>
        </div>
    </div>
    <div class="row" style="margin-top: 20px">
        <asp:GridView ID="gdvUPOV" runat="server"
            ...
            OnSelectedIndexChanged="gdvUPOV_SelectedIndexChanged">
