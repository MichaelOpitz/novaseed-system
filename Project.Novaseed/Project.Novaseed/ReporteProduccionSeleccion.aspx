<%@ Page Title="Producción" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReporteProduccionSeleccion.aspx.cs" Inherits="Project.Novaseed.ReporteProduccionSeleccion" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h2>
                    <asp:Label ID="lblProduccionReporte" runat="server" Font-Bold="true" Text="Producción" Font-Names="versalitas" /></h2>
            </div>
            <div class="col-sm-6" style="text-align: right">
                <div class="input-group" style="margin-top: 30px">
                    <asp:TextBox runat="server" type="text" class="form-control" ID="txtProduccionReporteBuscar" placeholder="Ingrese nombre de variedad"></asp:TextBox>
                    <span class="input-group-btn">
                        <asp:Button runat="server" class="btn btn-default" type="button" ID="btnProduccionReporteBuscar" Text="Buscar" OnClick="btnProduccionReporteBuscar_Click"></asp:Button>
                    </span>
                </div>
            </div>
        </div>
